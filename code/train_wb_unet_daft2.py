...
from networks import UNet3D_withDAFT
import pandas as pd
...
parser.add_argument('--exp', type=str, default='ISLES24-Unet_Daft2', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    model = UNet3D_withDAFT(in_channels=5, n_classes=num_classes, clinical_in_features=max(1, clinical_dim))
